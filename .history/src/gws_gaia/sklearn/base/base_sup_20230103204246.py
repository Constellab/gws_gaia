...
class BaseSupervisedTrainer(Task):
    ...
    @staticmethod
    def fit(params: ConfigParams, inputs: TaskInputs) -> BaseSupervisedResult:
    ...
    @staticmethod
    def predict(learned_model: BaseSupervisedResult, table: Table) -> Table:
    ...
    async def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        sklearn_trainer = self.fit(table = inputs['table']
        training_design = params["training_design"], inputs)
