...
```gws_gaia``` is a [Constellab](https://constellab.io) library (called bricks) developped by [Gencovery](https://gencovery.com/). GWS stands for Gencovery Web Services.
...
📄  For `gws_gaia` brick documentation, click [here](https://constellab.community/bricks/gws_gaia/latest/doc/getting-started/f7dd625a-029f-43ff-9026-187966d213f7)
...
The `gws_gaia` brick requires the `gws_core` brick.
...
```bash 
pip install scikit-bio==0.6.1 gpboost==1.4.0
```
...
```gws_gaia``` is completely free and open-source and licensed under the [GNU General Public License v3.0](https://www.gnu.org/licenses/gpl-3.0.en.html).
