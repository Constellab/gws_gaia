...
class ExtraTreesClassifierResult(BaseResourceSet):
    pass
...
class ExtraTreesClassifierTrainer(Task):
    ...
    output_specs = {'result': OutputSpec(ExtraTreesClassifierResult, human_name="result", short_description="The output result")}
    config_specs = {
...
class ExtraTreesClassifierPredictor(Task):
    ...
    """
    input_specs = {'dataset': InputSpec(Dataset, human_name="Dataset", short_description="The input dataset"),
            'learned_model': InputSpec(ExtraTreesClassifierResult, human_name="Learned model", short_description="The input model")}
