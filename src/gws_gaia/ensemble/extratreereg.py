...
class ExtraTreesRegressorResult(BaseResourceSet):
    pass
...
class ExtraTreesRegressorTrainer(Task):
    ...
    output_specs = {'result': OutputSpec(ExtraTreesRegressorResult, human_name="result", short_description="The output result")}
    config_specs = {
...
class ExtraTreesRegressorPredictor(Task):
    ...
    """
    input_specs = {'dataset': InputSpec(Dataset, human_name="Dataset", short_description="The input dataset"),
            'learned_model': InputSpec(ExtraTreesRegressorResult, human_name="Learned model", short_description="The input model")}
