...
class BernoulliNaiveBayesClassifierTrainer(Task):
    ...
    output_specs = {'result': OutputSpec(BernoulliNaiveBayesClassifierResult, human_name="result", short_description="The output result")}
    config_specs = {
...
class BernoulliNaiveBayesClassifierPredictor(Task):
    ...
    """
    input_specs = {'dataset': InputSpec(Dataset, human_name="Dataset", short_description="The input dataset"),
            'learned_model': InputSpec(BernoulliNaiveBayesClassifierResult, human_name="Learned model", short_description="The input model")}
