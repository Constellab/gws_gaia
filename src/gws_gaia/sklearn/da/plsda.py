...
import numpy as np
import pandas
from gws_core import (BoolParam, ConfigParams, DataFrameRField, FloatRField,
                      InputSpec, IntParam, OutputSpec, ParamSet, Resource,
                      RField, ScatterPlot2DView, ScatterPlot3DView, StrParam,
                      Table, TabularView, Task, TaskInputs, TaskOutputs,
...
class PLSDATrainerResult(BaseSupervisedResult):
    """ PLSDATrainerResult """
