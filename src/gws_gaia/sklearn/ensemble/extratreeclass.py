...
class ExtraTreesClassifierResult(BaseSupervisedClassResult):
    pass
...
class ExtraTreesClassifierTrainer(BaseSupervisedTrainer):
    ...
    #sklearn.ensemble.ExtraTreesClassifier.fit for more details
    ...
    output_specs = OutputSpecs({'result': OutputSpec(ExtraTreesClassifierResult,
    ...
    @classmethod
    def create_result_class(cls) -> Type[ExtraTreesClassifierResult]:
