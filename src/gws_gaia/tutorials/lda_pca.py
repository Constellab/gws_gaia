...
from gws_core import Protocol, Study, User, Experiment, ExperimentService
...
def lda_pca_experiment(data_file, delimiter=",", header=0, target=[], ncomp=2):
    ...
    experiment: Experiment = Experiment(
        protocol=proto, study=Study.get_default_instance(), user=User.get_sysuser())
    experiment.set_title("Short LDA and PCA experiment")
    experiment.set_description("This is a short LDA protocol provided to you to see how linear discrimant analysis could be implemented.")
    experiment.save()
