...
class DeepMoldelTurorialProto(Protocol):
    def configure_protocol(self, config_params: ConfigParams) -> None:
        ...
        p0: ProcessSpec = self.add_process(PickleImporter, 'p0')
        ...
        p10: ProcessSpec = self.add_process(DeepModelBuilder, 'p10')
        p11: ProcessSpec = self.add_process(DeepModelCompiler, 'p11')
