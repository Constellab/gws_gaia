...
from gws_gaia import GradientBoostingRegressorTrainer, GradientBoostingRegressorPredictor, GradientBoostingRegressorTester
...
class TestTrainer(BaseTestCase):
    ...
    async def test_process(self):
        ...
        tester = TaskTester(
            ...
            task_type = GradientBoostingRegressorTester
        )
        outputs = await tester.run()
...
#         p0 = DatasetLoader()
#         p1 = GradientBoostingRegressorTrainer()
#         p2 = GradientBoostingRegressorPredictor()
#         p3 = GradientBoostingRegressorTester()
