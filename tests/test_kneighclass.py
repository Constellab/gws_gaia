...
from gws_gaia import KNNClassifierTrainer, KNNClassifierPredictor, KNNClassifierTester
...
class TestTrainer(BaseTestCase):
    ...
    async def test_process(self):
        GTest.print("K-nearest neighbors classifier")
        settings = Settings.retrieve()
        test_dir = settings.get_variable("gws_gaia:testdata_dir")
        
        p0 = DatasetLoader()
        p1 = KNNClassifierTrainer()
        p2 = KNNClassifierPredictor()
        p3 = KNNClassifierTester()
