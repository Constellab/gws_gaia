...
class TestTrainer(IsolatedAsyncioTestCase):
    ...
    async def test_process(self):
        GTest.print("Random forest classifier")
        settings = Settings.retrieve()
        test_dir = settings.get_variable("gws_gaia:testdata_dir")

        p0 = DatasetLoader()
        p1 = RandomForestClassifierTrainer()
        p2 = RandomForestClassifierPredictor()
        p3 = RandomForestClassifierTester()
        ...
        p0.set_param("file_path", os.path.join(test_dir, "./dataset4.csv"))
