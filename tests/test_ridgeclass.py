...
from gws_gaia import RidgeClassifierTrainer, RidgeClassifierPredictor, RidgeClassifierTester
...
class TestTrainer(BaseTestCase):
    ...
    async def test_process(self):
        ...
        tester = TaskTester(
            ...
            task_type = RidgeClassifierTester
        )
        outputs = await tester.run()
...
#     async def test_process(self):
#         self.print("Ridge regression classifier")
#         settings = Settings.retrieve()
#         test_dir = settings.get_variable("gws_gaia:testdata_dir")

#         p0 = DatasetLoader()
#         p1 = RidgeRegressionTrainer()
#         p2 = RidgeRegressionPredictor()
#         p3 = RidgeRegressionTester()
